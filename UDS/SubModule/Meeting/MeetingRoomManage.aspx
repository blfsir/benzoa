<%@ Page Language="c#" CodeBehind="MeetingRoomManage.aspx.cs" AutoEventWireup="false"
    Inherits="UDS.SubModule.Meeting.MeetingRoomManage" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>MeetingRoomManage</title>
...
<%--<body ms_positioning="GridLayout" leftmargin="0" topmargin="0">
    ...
    <font face="宋体">
        ...
        <tr>
            <td>
                <asp:DataGrid ID="dbMeetingRoomList" runat="server" OnPageIndexChanged="DataGrid_PageChanged"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="RoomName" HeaderText="会议室" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateColumn HeaderText="编辑">
                            <HeaderStyle Width="5%"></HeaderStyle>
                            <ItemTemplate>
                                <a href='NewMeetingRoom.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID")%>'
                                    target="_self">编辑</a>
                            </ItemTemplate>
...
<body leftmargin="0" topmargin="0">
    ...
    <table width="100%" height="1" border="0" align="center" cellpadding="0" cellspacing="0"
        ...
        <tr height="30">
            ...
            <td class="GbText" background="../../../Images/treetopbg.jpg" bgcolor="#e8f4ff" align="right">
                <font face="宋体">
                      <asp:Button ID="btnAdd" runat="server" Text="新增" Width="80px" CssClass="redbuttoncss"></asp:Button>
                            <asp:Button ID="btnDelete" runat="server"  Width="80px" CssClass="redbuttoncss" Text="删除"></asp:Button>  &nbsp;</font>
            </td>
        </tr>
    </table>
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="Table1">
        ...
        <tr>
         <td style="line-height: 20px;"><table class="gbtext" id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
        ...
        <tr>
        <td> <asp:Label runat="server" ID="LabelPageInfo" Font-Size="X-Small"></asp:Label></td></tr>
