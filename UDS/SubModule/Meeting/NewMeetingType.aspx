<%@ Page Language="c#" CodeBehind="NewMeetingType.aspx.cs" AutoEventWireup="false" Inherits="UDS.SubModule.Meeting.NewMeetingType" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>NewMeetingType</title>
    ...
    <script language="javascript">
		...
		{			
			location.href ="MeetingTypeManage.aspx";			
		}
...
String.prototype.Trim = function()
{
    ...
    {
        //类型名称
        var TypeName = document.getElementById("txtTypeName").value.Trim();
        ...
        <table id="Table2" bordercolor="#111111" height="1" cellspacing="0" cellpadding="0"
            ...
            <tr height="30">
                ...
                <td class="GbText" background="../../Images/treetopbg.jpg" bgcolor="#c0d9e6">
                    <b><b><b><font face="宋体">新增会议类型</font></b></b></b>
                </td>
        ...
        <table class="gbtext" id="AutoNumber1" style="border-collapse: collapse" bordercolor="#93bee2"
            ...
            <tr bgcolor="#e8f4ff">
                ...
                <td style="height: 34px" height="34">
                    &nbsp;<asp:TextBox ID="txtTypeName" CssClass="InputCss" runat="server" Columns="70"
