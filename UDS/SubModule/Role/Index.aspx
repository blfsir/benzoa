...
<html>
	...
	<frameset id="thisFrame" cols="180,*" cols="184,76%">
		<frame name="LeftFrame" src="RoleTreeView.aspx" scrolling="auto" frameborder="0" border="0" framespacing="0">
		<frame name="MainFrame" src="ListView.aspx"  scrolling="auto" frameborder="0" border="0" framespacing="0">
		<noframes>
			<pre id="p2">
================================================================
关于完成此内容框架集的说明
