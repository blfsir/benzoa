		...
		<form id="ClientContact" method="post" encType="multipart/form-data" runat="server">
			...
			<TABLE class="gbtext" id="Table4" style="BORDER-COLLAPSE: collapse" borderColor="#93bee2"
				...
				<TR>
					...
					<TD colspan="2"><asp:literal id="ltl_ClientName" runat="server" Visible="False"></asp:literal><asp:panel id="pnl_clientselect" runat="server">
					...
					<td width="584">客户简称&nbsp;&nbsp;<asp:literal id="ltl_ClientShortName" runat="server"></asp:literal></td>
			    </TR>
				<TR>
					<TD width="120" height="30" align="center" bgColor="#E8F4FF" >最后填写接触时间</TD>
					<TD width="531" nowrap bgColor="#FFFFFF" >&nbsp;<asp:Literal id="ltl_UpdateTime" runat="server"></asp:Literal></TD>
					<TD  width="120" bgColor="#E8F4FF" align="center" colSpan="1" rowSpan="1">发现时间</TD>
					<TD  bgColor="#FFFFFF">&nbsp;
						<asp:Literal id="ltl_Birthday" runat="server"></asp:Literal></TD>
			    </TR>
				<TR>
					<TD width="120" height="30" align="center" bgColor="#E8F4FF" >接洽次数(合计)</TD>
					<TD nowrap  bgColor="#FFFFFF">&nbsp;<asp:literal id="ltl_ContactTimes" runat="server"></asp:literal></TD>
				...
				<TR>
					...
					<TD nowrap  bgColor="#FFFFFF">&nbsp;<asp:label id="lbl_BargainPrognosis" runat="server"></asp:label></TD>
				...
				<TR>
					<TD height="30" colSpan="4" align="center" bgColor="#E8F4FF">一周内添加的接触记录:</TD>
			    </TR>
				<TR>
					<TD colSpan="4">
