...
<HTML>
	...
	<body topmargin="5">
		<form id="Linkman" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="1" style="BORDER-COLLAPSE: collapse"
					...
					<TR>
						<TD width="120" height="30" bgcolor="#e8f4ff">&nbsp;姓名</TD>
						...
						<TD width="120" height="30" bgcolor="#e8f4ff">移动电话</TD>
						<TD>
						...
						<TD width="120" bgcolor="#e8f4ff" style="WIDTH: 31px">电话</TD>
						<TD>
				    ...
				    <asp:TextBox id="tb_Position" runat="server" CssClass="inputcss"></asp:TextBox></TD>
						<TD width="120" height="30" bgcolor="#e8f4ff">EMAIL</TD>
						<TD>
						...
						<TD width="120" bgcolor="#e8f4ff" style="WIDTH: 31px">性别</TD>
						<TD>
