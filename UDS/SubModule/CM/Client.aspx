		...
		<form id="Client" method="post" encType="multipart/form-data" runat="server">
			<FONT face="宋体">
				<TABLE borderColor="#111111" height="1" cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD width="24" height="30" background="../../Images/treetopbg.jpg" bgColor="#c0d9e6" class="GbText"><FONT color="#003366" size="3"><IMG height="16" src="../../DataImages/ClientManage.gif" width="16"></FONT></TD>
					...
					<TR>
						<TD>
							...
							<TABLE class="gbtext" id="Table2" style="BORDER-COLLAPSE: collapse" borderColor="#93bee2"
							  ...
							  <TR>
									<TD width="120" bgColor="#e8f4ff" height="30">&nbsp;客户编号</TD>
									<TD height="30">&nbsp;<asp:literal id="ltl_ID" runat="server"></asp:literal></TD>
									<TD width="120" bgColor="#e8f4ff" height="30">&nbsp;添加日期</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_Birthday" runat="server" CssClass="inputcss" Width="250px" ReadOnly="True"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;客户名称</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_Name" runat="server" CssClass="inputcss" Width="250px"></asp:textbox><asp:customvalidator id="CustomValidator1" runat="server" ControlToValidate="tbx_Name" ErrorMessage="客户名称重复"
									...
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;客户简称</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_ShortName" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;客户分类</TD>
									<TD height="30"><asp:checkbox id="cbx_zhongduan" runat="server" Text="终端客户"></asp:checkbox><asp:checkbox id="cbx_qudao" runat="server" Text="渠道商"></asp:checkbox><asp:checkbox id="cbx_shehui" runat="server" Text="社会关系"></asp:checkbox><asp:checkbox id="cbx_meiti" runat="server" Text="媒体公关"></asp:checkbox></TD>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;更新时间</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_UpdateTime" runat="server" CssClass="inputcss" Width="250px" ReadOnly="True"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;主要联系人</TD>
									<TD height="30" style="WIDTH: 400px">&nbsp;
									...
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;职务</TD>
									<TD height="30">&nbsp;<asp:label id="lbl_position" runat="server"></asp:label></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;联系电话</TD>
									<TD height="30">&nbsp;<asp:label id="lbl_chieftel" runat="server"></asp:label></TD>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;隶属区域</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_affiliatedarea" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;添加人员</TD>
									<TD height="30">&nbsp;<asp:literal id="ltl_AddManName" runat="server"></asp:literal>
									...
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;联系电话</TD>
									<TD height="30">&nbsp;<asp:literal id="ltl_addmantel" runat="server"></asp:literal></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;企业网址</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_URL" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;邮政编码</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_zip" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;企业地址</TD>
									<TD colSpan="3" height="30">&nbsp;<asp:textbox id="tbx_address" runat="server" CssClass="inputcss" Width="645px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;企业性质</TD>
									<TD height="30"><asp:checkbox id="cbx_government" runat="server" Text="政府"></asp:checkbox><asp:checkbox id="cbx_stateowned" runat="server" Text="国营"></asp:checkbox><asp:checkbox id="cbx_private" runat="server" Text="民营"></asp:checkbox><asp:checkbox id="cbx_foreign" runat="server" Text="外资"></asp:checkbox><asp:checkbox id="cbx_market" runat="server" Text="上市"></asp:checkbox></TD>
									<TD bgColor="#e8f4ff" height="30">&nbsp;注册资本</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_money" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="46" bgColor="#e8f4ff">&nbsp;所处行业</TD>
								...
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;公司规模</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_staffnumber" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
									<TD bgColor="#e8f4ff" height="30">&nbsp;主营业务</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_operation" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" bgColor="#e8f4ff">&nbsp;企业简介</TD>
								...
								<TR>
									<TD width="120" height="40" bgColor="#e8f4ff">&nbsp;信息化程度</TD>
									<TD colSpan="3" height="40">&nbsp;<asp:textbox id="tbx_IT" runat="server" Width="645px" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;电脑数量</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_pcnumber" runat="server" CssClass="inputcss" Width="250px"></asp:textbox>台<asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server" ControlToValidate="tbx_pcnumber" ErrorMessage="请输入数字"
									...
									<TD bgColor="#e8f4ff" height="30">&nbsp;网络状况</TD>
									<TD height="30"><asp:checkbox id="cbx_internet" runat="server" Text="互联网"></asp:checkbox><asp:checkbox id="cbx_WAN" runat="server" Text="WAN"></asp:checkbox><asp:checkbox id="cbx_LAN" runat="server" Text="LAN"></asp:checkbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;专业IT人员</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_ITStaffs" runat="server" CssClass="inputcss" Width="250px"></asp:textbox>人<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ControlToValidate="tbx_ITStaffs" ErrorMessage="请输入数字"
											Display="Dynamic"></asp:requiredfieldvalidator>
								...
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;IT部门名称</TD>
									<TD height="30">&nbsp;<asp:textbox id="tbx_ITdepartment" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
									<TD bgColor="#e8f4ff" height="30">&nbsp;负责人</TD>
									<TD height="30"><asp:textbox id="tbx_principal" runat="server" CssClass="inputcss" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;目前系统</TD>
									<TD colSpan="3" height="30">&nbsp;<asp:textbox id="tbx_system" runat="server" Width="645px" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;客户来源</TD>
									<TD colSpan="3" height="30"><asp:checkbox id="cbx_sellman" runat="server" Text="销售主动联系"></asp:checkbox><asp:checkbox id="cbx_just" runat="server" Text="以前认识"></asp:checkbox><asp:checkbox id="cbx_introduce" runat="server" Text="熟人介绍"></asp:checkbox><asp:checkbox id="cbx_customer" runat="server" Text="客户主动联系" AutoPostBack="True"></asp:checkbox></TD>
								</TR>
								<TR>
									<TD width="120" height="30" bgColor="#e8f4ff">&nbsp;客户主动</TD>
									<TD colSpan="3" height="30"><asp:panel id="penal" runat="server" CssClass="inputcss" Width="563px" Visible="False">
