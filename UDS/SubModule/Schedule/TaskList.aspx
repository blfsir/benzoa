    ...
    <table width="100%" height="1" border="0" align="center" cellpadding="0" cellspacing="0"
        ...
        <tr>
            ...
            <td class="GbText" background="../../Images/treetopbg.jpg" bgcolor="#e8f4ff" width="60"
                ...
                &nbsp;<font color="#006699">我的任务</font>
            </td>
            <td class="GbText" background="../../../Images/treetopbg.jpg" bgcolor="#e8f4ff" align="right">
                <font face="宋体">
                    <asp:Button ID="btnNew" runat="server" CssClass="redButtonCss" Width="80" Text="新 建">
                    </asp:Button>
                    <asp:Button ID="btnAccept" runat="server" CssClass="redButtonCss" Text="接 受" Width="80">
                    </asp:Button>
                    <asp:Button ID="btnCancel" runat="server" CssClass="redButtonCss" Text="取 消" Width="80">
                    </asp:Button>&nbsp;
                    <asp:Button ID="btnSubscribe" runat="server" CssClass="redButtonCss" Text="订 阅" Width="80"
                        Visible="False"></asp:Button>&nbsp;观察视角:<asp:DropDownList ID="listStaff" runat="server"
                            Width="105px" AutoPostBack="true" OnSelectedIndexChanged="listStaff_SelectedIndexChanged">
                        </asp:DropDownList>
                    &nbsp;</font>
            </td>
        </tr>
    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="Table1">
        <tr>
            <td>
                ...
                <table id="tblContainer" height="25" cellspacing="0" cellpadding="0" width="100%"
                    border="0" runat="server">
                    <tr>
                        <td id="bar1" align="center" width="90" background="../../images/maillistbutton1.gif">
                            &nbsp;<font face="宋体"><asp:LinkButton ID="lnkbtnToday" runat="server" CssClass="Newbutton">待完成</asp:LinkButton></font>
                        </td>
                        <td id="bar2" align="center" width="90" background="../../images/maillistbutton1.gif">
                            &nbsp;<asp:LinkButton ID="lnkbtnHistory" runat="server" CssClass="Newbutton">未完成</asp:LinkButton>
                        </td>
                        <td id="bar3" align="center" width="90" background="../../images/maillistbutton1.gif">
                            <asp:LinkButton ID="lnkbtnFinished" runat="server" CssClass="Newbutton">已完成</asp:LinkButton>&nbsp;
                        </td>
                        <td id="bar4" align="center" width="90" background="../../images/maillistbutton1.gif">
                            <font face="宋体">&nbsp; </font>
                            <asp:LinkButton ID="Linkbutton1" runat="server" CssClass="Newbutton">我的订阅</asp:LinkButton>&nbsp;
                        </td>
                        <td id="bar5" align="center" width="90" background="../../images/maillistbutton1.gif"
                            style="width: 91px">
                            <font face="宋体">&nbsp;<asp:LinkButton ID="lnkbtnArranged" runat="server" Width="59px"
                                CssClass="Newbutton">我的发起</asp:LinkButton></font>
                        </td>
                        <td align="right">
                            <font face="宋体">
                                <asp:Button ID="btnWeeklyView" runat="server" Text="周览" CssClass="greenButtonCss"
                                    Width="80"></asp:Button>
                                <asp:Button ID="btnCancelSubscription" runat="server" Text="取消订阅" CssClass="greenButtonCss"
                                    Width="80" Visible="False"></asp:Button></font>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="line-height: 20px;">
                <asp:DataGrid ID="dgList" runat="server" Font-Size="X-Small" BackColor="White" CssClass="top"
                    Width="100%" AllowPaging="True" CellPadding="3" AutoGenerateColumns="False" PagerStyle-Mode="NumericPages"
                    PagerStyle-HorizontalAlign="Right" OnPageIndexChanged="DataGrid_PageChanged"
                    DataKeyField="ID" BorderColor="#93BEE2" BorderWidth="1px">
                    <AlternatingItemStyle BackColor="#E8F4FF"></AlternatingItemStyle>
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="选择">
                            <HeaderStyle HorizontalAlign="Center" Width="5%"></HeaderStyle>
                            <ItemStyle Font-Size="X-Small" HorizontalAlign="Left" Height="20px" Width="60px">
                            </ItemStyle>
                            <ItemTemplate>
                                <asp:CheckBox ID="grpID" Checked="False" runat="server"></asp:CheckBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="时段">
                            ...
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.Date").ToString()).ToShortDateString()+"  "+GetPeriodByPeriodID(DataBinder.Eval(Container, "DataItem.EndTime").ToString(),DataBinder.Eval(Container, "DataItem.beginPeriodID").ToString(),(DataBinder.Eval(Container, "DataItem.endPeriodID").ToString())) %>'
                                    ID="Label2" NAME="Label2">
                                </asp:Label>
                                <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Date").ToString() %>'
                                    ID="Label1" NAME="Label2" Visible="false">
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="内容">
                            ...
                            <ItemTemplate>
                                <a href="#" onclick='javascript:return dialwinprocess("<%# DataBinder.Eval(Container, "DataItem.Date") %>","","2","<%# DataBinder.Eval(Container, "DataItem.TaskID") %>")'>
                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Subject") %>'
                                        ID="Label3" NAME="Label3"></a> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="状态">
                            <HeaderStyle HorizontalAlign="Center" Width="5%"></HeaderStyle>
        ...
        <tr>
            <td align="left">
                <font face="宋体">
                    <asp:Table ID="Table3" runat="server" CssClass="top" Visible="False" Width="100%"
                        BorderWidth="0px" Height="195px">
                    </asp:Table>
                    <asp:Label ID="lblInstru" runat="server" Font-Size="X-Small"> </asp:Label></font>
            </td>
        </tr>
    </table>
    </form>
