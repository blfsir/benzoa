        ...
        <tr>
            <td>
                <table border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse"
                    bordercolor="#93bee2" width="98%" id="AutoNumber2" height="1" class="GbText"
                    align="center">
                    <tr>
                        <font face="宋体"></font>
                        ...
                        <tr>
                            ...
                            <td height="30" colspan="2" align="center">
                                <asp:Button ID="cmdOK" runat="server" Width="60px" CssClass="buttoncss" Text="确定"
                                    OnClick="cmdOK_Click"></asp:Button><font face="宋体">&nbsp;&nbsp;</font>
                                <input class="buttoncss" style="width: 60px" onClick="javascript:location.href='NewsManagement.aspx'"
                                    type="button" value="返回">
                            </td>
