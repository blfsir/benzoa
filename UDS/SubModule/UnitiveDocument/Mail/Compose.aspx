	...
	<body leftMargin="0" MS_POSITIONING="GridLayout" topmargin="0">
        ...
        <TABLE borderColor="#111111" height="1" cellSpacing="0" cellPadding="0" width="100%" border="0">
			...
			<table width="98%" border="0" align="center" cellPadding="0" cellSpacing="0">
					...
					<td vAlign="bottom" height="25">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr height="25">
								...
								<td id="bar1" align="center" width="90" background="../../../images/maillistbutton1.gif">&nbsp;<A href="Index.aspx?FolderType=1" class="Newbutton">收件箱</A></td>
								<td id="bar2" align="center" width="90" background="../../../images/maillistbutton1.gif">&nbsp;<A href="Index.aspx?FolderType=2" class="Newbutton">发件箱</A></td>
								<td id="bar3" align="center" width="90" background="../../../images/maillistbutton1.gif">&nbsp;<A href="Index.aspx?FolderType=3" class="Newbutton">废件箱</A></td>
								<td id="bar4" align="center" width="90" background="../../../images/maillistbutton2.gif">&nbsp;<A href="Compose.aspx?ClassID=0" class="Newbutton">撰写新邮件</A></td>
				...
				<tr>
					<td bgColor="#93bee2" colSpan="5" height="30"><FONT style="BACKGROUND-COLOR: #ffffff" face="宋体"></FONT></td>
				</tr>
				<tr>
					<td><table cellSpacing="0" cellPadding="3" width="100%" border="1" borderColor="#93bee2">
					<tr>
								<td width="120" height="30" align="right" bgcolor="#E8F4FF"><asp:label id="lblSendTo" runat="server" CssClass="Text" Font-Size="X-Small">收件人:</asp:label><FONT face="宋体">&nbsp;</FONT></td>
								<td><input class=InputCss 
            style="WIDTH: 400px; HEIGHT: 19px" readOnly type=text size=62 
            value="<%=SendToRealName%>" name=txtSendTo 
            >&nbsp;<A style="CURSOR: hand" onClick="dialwinprocess(1)" href="#"><FONT face="宋体">选择收件人</FONT></A></td>
							</tr>
							<tr>
								<td width="120" height="30" align="right" bgcolor="#E8F4FF"><asp:label id="lblCcTo" runat="server" CssClass="Text" Font-Size="X-Small">抄送人:</asp:label><FONT face="宋体">&nbsp;</FONT></td>
								<td><input class=InputCss 
            style="WIDTH: 400px; HEIGHT: 19px" readOnly type=text size=62 
            value="<%=CcToRealName%>" name=txtCcTo>&nbsp;<A style="CURSOR: hand" onClick="dialwinprocess(2)" href="#"><FONT face="宋体">选择抄送人</FONT></A></td>
							</tr>
							<tr>
								<td width="120" height="30" align="right" bgcolor="#E8F4FF"><asp:label id="lblBccTo" runat="server" CssClass="Text" Font-Size="X-Small">秘抄人:</asp:label><FONT face="宋体">&nbsp;</FONT></td>
								<td><input class=InputCss 
            style="WIDTH: 400px; HEIGHT: 19px" readOnly type=text size=62 
            ...
            >&nbsp;<A style="CURSOR: hand" onClick="dialwinprocess(2)" href="#"><FONT face="宋体">选择密送人</FONT></A></td>
							...
							<tr>
								<td width="120" height="30" align="right" bgcolor="#E8F4FF" style="HEIGHT: 21px"><asp:label id="lblSubject" runat="server" CssClass="Text" Font-Size="X-Small" Width="40px">主&nbsp;&nbsp;题:</asp:label><FONT face="宋体">&nbsp;</FONT></td>
								<td style="HEIGHT: 21px"><asp:textbox id="txtSubject" runat="server" CssClass="InputCss" Width="484px"></asp:textbox></td>
							</tr>
							<tr height="30">
								<td width="120" height="30" align="right" bgcolor="#E8F4FF"><asp:label id="lblImportance" runat="server" CssClass="Text" Font-Size="X-Small">重要性:</asp:label><FONT face="宋体">&nbsp;</FONT></td>
            ...
            value="<%=GetClassName() %>" width="20"><input class="redButtonCss" onClick="ProjectSelect()" type="button" value="▼">
							...
							<tr>
								<td width="120" height="30" align="right" bgcolor="#E8F4FF"><asp:label id="lblBody" runat="server" CssClass="Text" Font-Size="X-Small">内&nbsp;&nbsp;容:</asp:label><FONT face="宋体">&nbsp;</FONT></td>
