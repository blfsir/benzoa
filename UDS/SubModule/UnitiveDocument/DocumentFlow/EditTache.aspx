            ...
            <TABLE borderColor="#111111" height="1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
								  ...
								  <TD width="60" height="30" align="right" background="../../../Images/treetopbg.jpg"
										bgColor="#e8f4ff" class="GbText" style="WIDTH: 53px"><font color="#006699">文档流转</font></TD>
				...
				<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TR>
						...
						<TR>
									<TD width="120"
										height="30"  align="center" bgcolor="#E8F4FF">流程名称：</TD>
									<TD ><asp:label id="labFlowName" runat="server" Width="384px"></asp:label><asp:label id="labStep" runat="server" Width="91px"></asp:label></TD>
								</TR>
								<TR>
									<TD width="120" height="30" align="center" bgcolor="#e8f4ff"><asp:label id="Label1" runat="server" Width="70px" Height="12px">步骤名称：</asp:label></TD>
								  <TD  height="25"><asp:textbox id="txtTacheName" runat="server" Width="483px" Height="21px" CssClass="inputcss"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" Width="166px" ErrorMessage="请输入步骤名称"
											ControlToValidate="txtTacheName"></asp:requiredfieldvalidator></TD>
								</TR>
								<TR>
									<TD width="120" height="30"  align="center" bgcolor="#e8f4ff"><asp:label id="Label2" runat="server">是否结束：</asp:label></TD>
								...
								<TR>
									<TD width="120" height="30" align="center" bgcolor="#e8f4ff"><asp:label id="Label5" runat="server">是否汇签：</asp:label></TD>
								  <TD ><asp:radiobutton id="radPassNumYes" runat="server" Text="会签" GroupName="PassNum" AutoPostBack="True"></asp:radiobutton><asp:radiobutton id="radPassNumNo" runat="server" Text="不会签" GroupName="PassNum" Checked="True" AutoPostBack="True"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<TR>
									<TD width="120" height="30"  align="center" bgcolor="#e8f4ff"><asp:label id="Label3" runat="server" Width="65px" Height="9px">流转规则：</asp:label></TD>
							  <TD style="HEIGHT: 24px" ><asp:dropdownlist id="cboFlowRule" runat="server" Width="488px">
								...
								<TR>
									<TD align="center" bgcolor="#e8f4ff"><asp:label id="Label4" runat="server" Width="72px" Height="6px">步骤简介：</asp:label></TD>
								...
								<TR>
									<TD align="center" vAlign="middle" bgcolor="#e8f4ff">对一定时间内未完成审批提醒：</TD>
