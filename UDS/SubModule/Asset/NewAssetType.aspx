<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewAssetType.aspx.cs" Inherits="UDS.SubModule.Asset.NewAssetType" %>
                ...
                <td align="center" colspan="2" height="35">
                    <font face="宋体">
                        ...
                        <input class="redButtonCss" style="width: 60px; height: 20px"  
                            type="button" value="返 回" name="cmdReturn"  onclick="javacript:location.href='AssetTypeManage.aspx'" > 
                    </font>
                </td>
            </tr>
        </table>
