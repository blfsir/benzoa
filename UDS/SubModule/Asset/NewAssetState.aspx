<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewAssetState.aspx.cs" Inherits="UDS.SubModule.Asset.NewAssetState" %>
                ...
                <td style="height: 34px" height="34">
                    &nbsp;<asp:TextBox ID="txtName" CssClass="InputCss" runat="server" Columns="70"
                        Width="382"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                            runat="server" ErrorMessage="请输入规格型号名称" ControlToValidate="txtName" Font-Size="X-Small"></asp:RequiredFieldValidator><asp:Literal
                ...
                <td align="center" colspan="2" height="35">
                    <font face="宋体">
                        ...
                        <input class="redButtonCss" style="width: 60px; height: 20px"  
                            type="button" value="返 回" name="cmdReturn"  onclick="javacript:location.href='AssetStateManage.aspx'" > 
                    </font>
                </td>
            </tr>
        </table>
